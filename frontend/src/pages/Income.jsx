...
const Income = () => {
  ...
  const [loading, , ,handledelete,handledeleteall,handlegetincome,handleincome, ,Update, , , , , ,handlerlogout ] = useAuth()
 ...
 async function getdata(){
  ...
  const response = await handlegetincome()
  ...
  const deleteall = async()=>{
    ...
    await handledeleteall(copyTask[0].user)
    copyTask.splice([])
    setTask(copyTask)
  }
  ...
  const updateincome = async() => {
        ...
        await Update(editchange,task[editindex]._id)
        setTask(copyTask)
  }
  ...
  return (
    <div className='flex min-h-screen overflow-hidden bg-gray-200 relative'>
      ...
      <main className='flex-1 h-screen overflow-y-scroll overflow-x-hidden'>
        ...
        <div className='relative'>
            <div className='bg-gray-300 flex items-center justify-center w-10 h-10 rounded-full'>
        ...
        openProfile && (
          ...
          <div
            className='absolute flex items-center right-0 mt-3 w-40 bg-white shadow-lg rounded-xl p-3 z-50'
          >
            <button onClick={handlelogout}
              className='w-full flex items-center gap-3 text-left cursor-pointer text-red-500 hover:bg-gray-100 p-2 rounded-lg'
            ><p className='hover:bg-gray-200'><LogOutIcon /></p>
              Logout
            </button>
